...
function SellerInventory() {
  ...
  const handleAction = (item, action) => {
    ...
    if (action === "vouchers") navigate(`/seller/marketing?tab=discounts&listingId=${item._id}`);
